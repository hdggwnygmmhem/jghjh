...
const _0xde = (str) => Buffer.from(str, 'base64').toString('utf-8');
...
async (conn, mek, m, { from, quoted, body, args, q, reply, react, socket, sock }) => {
    ...
    // API CONFIGURATION - Base64 Hidden
    const apiKey = _0xde("VmFqaXJhT2Zj");
    const searchApiUrl = _0xde("aHR0cHM6Ly92YWppcmFvZmMtYXBpcy52ZXJjZWwuYXBwL2FwaS9jaW5lZmx1cmEvc2VhcmNo");
    const detailsApiUrl = _0xde("aHR0cHM6Ly92YWppcmFvZmMtYXBpcy52ZXJjZWwuYXBwL2FwaS9jaW5lZmx1cmEvZGV0YWlscw==");
